        ...
        <ContentTemplate>
            <div class="row">
                ...
                <div class="col-md-7">
                    ...
                    <asp:SqlDataSource ID="SqlSourceEgg" runat="server" ConnectionString="<%$ ConnectionStrings:someeDB %>" SelectCommand="SELECT EggSizes, Quantity, FORMAT(CAST(Dates AS DATE), 'dd-MMM-yyyy') as date FROM [EggSizesAvailable]"></asp:SqlDataSource>
                    ...
                    <asp:SqlDataSource ID="SqlSourceWholeChicken" runat="server" ConnectionString="<%$ ConnectionStrings:someeDB %>" SelectCommand="SELECT WholeType, Quantity, FORMAT(CAST(Dates AS DATE), 'dd-MMM-yyyy') as date FROM [WholeChickenAvailable]"></asp:SqlDataSource>
                    ...
                    <asp:SqlDataSource ID="SqlSourceChickenParts" runat="server" ConnectionString="<%$ ConnectionStrings:someeDB %>" SelectCommand="SELECT ChickenParts, Kilos, FORMAT(CAST(Date AS DATE), 'dd-MMM-yyyy') as date FROM [ChickenPartsAvailable]"></asp:SqlDataSource>
